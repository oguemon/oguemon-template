...
<div class="category-linear-algebra">
	...
	<div class="description">
		...
		<a href="https://oguemon.com/tools/calc/mat-det-inv.html" target="_blank" class="button">便利な計算機を使ってみる</a>
	</div>
	...
	<div class="article_list">
		<a href="https://oguemon.com/study/linear-algebra/overview-1/">
	...
	<dl class="article_list">
		...
		<a href="https://oguemon.com/study/linear-algebra/diagonalization/">
			<dt>行列の対角化と具体的な計算例</dt>
			<dd>行列の対角化って何？どこで便利？具体的な方法は？対角化の基本について1から解説。</dd>
		</a>
		<a href="https://oguemon.com/study/linear-algebra/diagonalization-symmetric-mat/">
			<dt>対称行列の対角化</dt>
			<dd>対称行列は絶対に対角化できます。対称行列の対角化に焦点を当て、その理由と性質を見ます。</dd>
		</a>
		<a href="https://oguemon.com/study/linear-algebra/triangularization/">
			<dt>行列の三角化</dt>
			<dd>正方行列の三角化について、その性質や方法などを具体例を用いて解説。</dd>
		</a>
		<a href="https://oguemon.com/study/linear-algebra/cayley-hamilton-theorem/">
			<dt>ケーリー・ハミルトンの定理</dt>
			<dd>昔の高校生がお世話になったこの定理。みんなが勘違いするポイントがあるので注意しよう。</dd>
		</a>
		<a href="https://oguemon.com/study/linear-algebra/frobenius-theorem/">
			<dt>フロベニウスの定理</dt>
