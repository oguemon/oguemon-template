...
function oguemon_scripts() {
	...
	//CSSスタイルの追加
	wp_enqueue_style('oguemon-style', $theme_root . '/css/common.css', false, '1.0.180716', 'all');
	...
	wp_enqueue_script('original', $theme_root . '/js/oguemon.min.js', array('jquery-alt'), '1.0.180716', true);
}
